            ...
            <form method="post" class="modal-body" id="contact_data_submit">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-sm-6 ">
                        ...
                        <input type="text" class="form-control required validate" name="mob" placeholder="Enter Mobile No.">
                    </div>
                </div>
                <!--                Website-->
                <div class="form-group row">
                ...
                <div class="form-group">
                    ...
                    <button type="submit" class="btn btn-success validate">Submit</button>
                </div>
